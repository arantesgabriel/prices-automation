...
def main():
    ...
    try:
        ...
        dataSheet = result['values'];
        print(dataSheet)

        # Validar leitura de linha que possua apenas números
        # for i, linha in enumerate(dataSheet):
        #     if linha > 1:
        ...
        result = sheet.values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID,
                                    range="F10", valueInputOption="USER_ENTERED", body={'values': addPrice}).execute()
